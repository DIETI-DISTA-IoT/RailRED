...
module.exports = {
     ...
     ******************************************************************************/
        ...
        // Add the flow manually:
        //flowFile: 'flows.json',
        // Automatically add the flow:
        flowFile : 'TCMS.json',
     ...
     ******************************************************************************/
        ...
        functionGlobalContext: {
            ...
            get weibull_array() {
                try {
                    console.log("importing random-array-weibull library...")
                    return require("@stdlib/random-array-weibull");
                } catch (e) {
                    console.error("Error loading @stdlib/random-array-weibull:", e.message);
                    return null;
                }
            }
        },
